...
<body>
<?php $this->beginBody() ?>
<?php $username = Helper::getUserName(Yii::$app->user->id) ?>
<!--НОВЫЙ ШАБЛОН-->
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/secure/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?= $username ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="/secure/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                <p>
                                    <?= $username ?>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>Добавить мероприятие</a></li>
                        <li><a href="index2.html"><i class="fa fa-circle-o"></i>Все мероприятия</a></li>
                    </ul>
                </li>
